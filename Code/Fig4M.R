...
ht1 <- netAnalysis_signalingRole_heatmap(D80_WT_new, width = 30, height = 30, pattern = "outgoing")
ht2 <- netAnalysis_signalingRole_heatmap(D80_WT_new, width = 30, height = 30, pattern = "incoming")
