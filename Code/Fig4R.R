...
genes_of_interest <- c("Ogfrl1", "Tram1", "Sox17", "Rgs20", "Pkhd1", "Cops5", "Dnajb3", "Fam135a", "C2cd6b", "Tmem131", "Stau2", "Osbpl8", "Smt3h2-ps4", "Rp1", "Maip1", "Prkag3", "Pcmtd1", "Lypla1")
...
gene_orders <- c("Ogfrl1", "Tram1", "Sox17", "Rgs20", "Pkhd1", "Cops5", "Dnajb3", "Fam135a", "C2cd6b", "Tmem131", "Stau2", "Osbpl8", "Smt3h2-ps4", "Rp1", "Maip1", "Prkag3", "Pcmtd1", "Lypla1")
...
png("heatmap_plot_5267_D80.png", width = 600, height = 1500)
