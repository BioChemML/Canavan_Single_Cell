...
WT_D30 <- readRDS("/location_where_you_input_file_is/D30_WT_1k.rds")
Can_D30 <- readRDS("/location_where_you_input_file_is/D30_Can_1k.rds")
...
groupSize <- as.numeric(table(D30_WT_new@idents))

png("plot_Can.png", width = 40*300, height = 32*300, res = 500)
netVisual_circle(D30_WT_new@net$count, 
                 vertex.weight = groupSize,
                 idents.use = "clstclst5267",
